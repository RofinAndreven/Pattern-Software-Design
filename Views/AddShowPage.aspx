<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Main.Master" AutoEventWireup="true" CodeBehind="AddShowPage.aspx.cs" Inherits="ProjectPSD.Views.AddShowPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
       ...
       <br />
        <asp:Button ID="btnInsert" OnClick="btnInsert_Click" Text="Insert" runat="server" />
